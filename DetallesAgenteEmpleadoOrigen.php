...
<title>Detalles </title> <!--Titulo del archivo de indextab.php-->
  ...
  <div class="subTituloEstadi0"><!--clases para ser utilizada en el archivo de css-->
       ...
       <H2><legend>Tickets en estado cerrado</br>Detalles del Departameto de Origen de: <?php echo $VarExportAgente;?></legend></H2><!--Titulo que se muestra en la presentacion de la pagina web-->
  </div>
    </br></br>
...
require_once("ConDetallesAgenteCeEmpleadoOrigen.php");
?>
</div>
