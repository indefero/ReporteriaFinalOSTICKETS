...
$VarExport=0;
 $VarExportAgentess =  $_COOKIE["VarCookieNombreAgentess"];
?>
...
<title>Detalles </title> <!--Titulo del archivo de indextab.php-->
  ...
  <div class="subTituloEstadi0"><!--clases para ser utilizada en el archivo de css-->
       <H2><legend>Tickets en estado Abierto</br>Detalles del agente: <?php echo $VarExportAgentess; ?></legend></H2><!--Titulo que se muestra en la presentacion de la pagina web-->
  </div>
    </br></br>
...
<?php
require_once("ConDetalleAgenteAbierto.php");
?>
</div>
