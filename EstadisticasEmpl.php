<?php
//Este php es el que muestra las estaditicas generales de los empleados y por intervalos de fecha
...
<title>Estadìsticas de Empleado</title> <!--Titulo del archivo de indextab.php-->

  <div class="subTituloEstadi0"><!--clases para ser utilizada en el archivo de css-->
       <H1><legend>Estadìsticas de los Empleado por Tickets </legend></H1><!--Titulo que se muestra en la presentacion de la pagina web-->
  </div>
    </br></br>
...
document.cookie ='VarCookieDestino='+data+';'; // Cooki sin fecha de expiraciòn
    ...
    //window.location="DetallesEmpleado.php";
    window.location="DetalleIndividualEmpleadoOrigen.php";
...
<body>
<div class="TablaEstadiEmpl">
<FORM action="DetallesEmpleado.php" method="POST">
 <?php 

 require_once("ConQueryEstaEmp.php");
  ...
  echo"<table border=1 align='center' cellspacing=0 cellpadding=2 id='Exportar_a_Excel'>";// creacion de la tabla con los encabezados que se mostarar en el pantalla principal de las estadisticas por departamento
   echo "<tr align='center' bgcolor='bbbbbb' >
                 ...
                 <td  ALIGN=CENTER>Nombre de Empleado</td>
...
<!--Llenado de la tabla por cada valor segùn su columna-->
         <tr data-valor="<?php echo($key['nombre'])?>" class="click">
              ...
              <td width=20%><a href='DetallesEmpleado.php'><strong><?php echo($key['nombre'])?></a></strong></td>
