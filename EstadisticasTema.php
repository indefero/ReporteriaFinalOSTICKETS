 <?php
 //Este php es el que muestra las estaditicas generales de los temas de ayuda y por intervalos de fecha
...
document.cookie="VarCookieFinalq=0; expires=+strExpiracion";
  ...
  <div class="subTituloEstadi0"><!--clases para ser utilizada en el archivo de css-->
	     <H1><legend>Estadìsticas de los Temas de Ayuda  por Tickets </legend></H1><!--Titulo que se muestra en la presentacion de la pagina web-->
  </div>
    </br></br>

	<center><div class="MenuEstadi"><!--Clases para ser utilizada en el archivo de css para el control del menu-->
 		 <form name="inicios" method="POST" >
     <ul>
     			 <li><a <input  type="submit" name="BTNIni" id="BTNIni" value="Inicio" onclick="self.location.href ='indexTab.php'" onkeypress="self.location.href ='indexTab.php'"/>Inicio</a></li>
           <Li><a <input  type="submit" name="BTNAsig" id="BTNAsig" value="Asignado" onclick="self.location.href ='BusquedaTickAsig.php'" onkeypress="self.location.href ='BusquedaTickAsig.php'"/>Asignado</a></Li>
           <li><a href="">Tickets</a>
                    <ul class="tiket">
                   <Li><a <input  type="submit" name="BTNCerrar" id="BTNCerrar" value="Ticket cerrado" onclick="self.location.href ='TicketCerrado.php'" onkeypress="self.location.href ='TicketCerrado.php'"/>Tickets Cerrado</a></Li>
                      <hr>
                       <li><a <input  type="submit" name="BTNAbierto" id="BTAbierto" value="Ticket abierto" onclick="self.location.href ='TicketAbierto.php'" onkeypress="self.location.href ='TicketAbierto.php'"/> Tickets Abierto</a></li>
                       </ul>
                  </li>
                  <li><a href="">Estadìsticas</a>
                    <ul class="estad">
                    <li><a <input  type="submit" name="BTNTema" id="BTNTema" value="Ticket tema" onclick="self.location.href ='EstadisticasTema.php'" onkeypress="self.location.href ='EstadisticasTema.php'"/>Ticket por Tema de Ayuda</a></li>
                    <hr>
                    <li><a <input  type="submit" name="BTNEmpleado" id="BTNEmpleado" value="Ticket empleado" onclick="self.location.href ='EstadisticasEmpl.php'" onkeypress="self.location.href ='EstadisticasEmpl.php'"/> Ticket Asig. Empleado.</a></li>
                    <hr>
                     <Li><a <input  type="submit" name="BTNDestino" id="BTNDestino" value="Ticket por Departamentos Destino" onclick="self.location.href ='EstadisticasDepart.php'" onkeypress="self.location.href ='EstadisticasDepart.php'"/>Ticket por Departamentos Destino</a></Li>
                    <hr>
                     <Li><a <input  type="submit" name="BTNOrigen" id="BTNOrigen" value="Ticket por Departamento de Origen" onclick="self.location.href ='EstadisticasDepartOrigen.php'" onkeypress="self.location.href ='EstadisticasDepartOrigen.php'"/>Ticket por Departamentos Origen  
        </a></Li>
                    </ul>
                    </li>
...
document.cookie ='VarCookieDestino='+data+';'; // Cooki sin fecha de expiraciòn
    ...
    //window.location="DetallesTemaAyuda.php";
     window.location="DetalleIndividualTema.php";
...
<body>
<div class="TablaEstadiTema">
<FORM action="DetallesTemaAyuda.php" method="POST">
 <?php 

 require_once("ConQueryEstaTema.php");
  ...
  echo"<table border=1 align='center' cellspacing=0 cellpadding=2 id='Exportar_a_Excel'>";// creacion de la tabla con los encabezados que se mostarar en el pantalla principal de las estadisticas por departamento
   echo "<tr align='center' bgcolor='bbbbbb' >
                 ...
                 <td  ALIGN=CENTER>Temas de Ayuda</td>
...
<!--Llenado de la tabla por cada valor segùn su columna-->
         <tr data-valor="<?php echo($key['nombre'])?>" class="click">
              ...
              <td width=20%><a href='DetallesDeptOrigen.php'><strong><?php echo($key['nombre'])?></a></strong></td>
