...
<title>Detalles </title> <!--Titulo del archivo de indextab.php-->
  ...
  <div class="subTituloEstadi0"><!--clases para ser utilizada en el archivo de css-->
         <H1><legend>Tickets Remitidos por Empleados del Departamento de <?php echo $VarExport; ?> </legend></H1><!--Titulo que se muestra en la presentacion de la pagina web-->
  </div>
    </br></br>
...
<div class="AyudaIndividualDetalle">
 ...
 <form name="atrass" method="POST"  action="EstadisticasDepartOrigen.php">
         ...
         <p>Atras  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input style='background:url("img/atrasimg.png");' type="submit" name="BTNatras" id="BTNatras" value=" &nbsp;" onclick="self.location.href ='EstadisticasDepartOrigen.php'" onkeypress="self.location.href ='EstadisticasDepartOrigen.php'" Title="ir a resultados anteriores"/></P>  
...
require_once("ConIndividualDeptOrigen.php");
?>
<!--</div>-->
