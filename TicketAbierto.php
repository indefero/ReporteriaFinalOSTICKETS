...
<!--Este PHP es el encargado de mostar en pantalla la informaciòn de los ticket ene estado abiertos-->
...
?>
	...
	<title>Reportería de Tickets Abierto</title> <!--Titulo del archivo de indextab.php-->
	

<div class="subTituloAbierto"><!--clases para ser utilizada en el archivo de css-->
	<H1><legend>Reporterìa de Tickets Abierto</legend></H1><!--Titulo que se muestra en la presentacion de la pagina web-->
</div>
</br></br></br></br></br>
...
<div class="AyudaCeAbAs">
 ...
 <form name="atrass" method="POST"  action="TicketAbierto.php">
...
// llamdo de las hojas de php requeridas para mostrar en pantalla
   require_once("ConQueryAb.php");// llamada de los query con su tabla
