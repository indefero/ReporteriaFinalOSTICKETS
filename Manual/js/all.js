...
/*js/drexplain/nav-tree/views/navTree.item-decoration.view.js*/
	window.NavTree__ItemDecoration_View = 
	{
		...
		html_expander_doClose: '<span class="b-tree__i_expander_doClose"><img class="b-tree__i_expander_doClose_inner" alt="�" title="" src="Imga/i/null.gif" /></span>',
		html_expander_doOpen: '<span class="b-tree__i_expander_doOpen"><img class="b-tree__i_expander_doOpen_inner" alt="+" title="" src="Imga/i/null.gif" /></span>',
		...
		html_render_folder_expander_angle_tl_cached: '<span class="b-tree__spacer"><span class="b-tree__i_angle_tl"><span class="b-tree__i_angle_tl_inner"></span></span><span class="b-tree__i_expander_doClose"><img class="b-tree__i_expander_doClose_inner" alt="-" title="" src="Imga/i/null.gif" /></span></span>',
		html_render_folder_expander_hline_mr_cached: '<span class="b-tree__spacer"><span class="b-tree__i_hLine_mr"><span class="b-tree__i_hLine_mr_inner"></span></span><span class="b-tree__i_expander_doClose"><img class="b-tree__i_expander_doClose_inner" alt="-" title="" src="Imga/i/null.gif" /></span></span>',
		html_render_folder_expander_angle_bl_cached: '<span class="b-tree__spacer"><span class="b-tree__i_angle_bl"><span class="b-tree__i_angle_bl_inner"></span></span><span class="b-tree__i_expander_doClose"><img class="b-tree__i_expander_doClose_inner" alt="-" title="" src="Imga/i/null.gif" /></span></span>',
		html_render_folder_expander_angle_tl_tb_cached: '<span class="b-tree__spacer"><span class="b-tree__i_angle_tl"><span class="b-tree__i_angle_tl_inner"></span></span><span class="b-tree__i_vLine_tb"><span class="b-tree__i_vLine_tb_inner"></span></span><span class="b-tree__i_expander_doClose"><img class="b-tree__i_expander_doClose_inner" alt="-" title="" src="Imga/i/null.gif" /></span></span>',
		html_render_folder_expander_doclose_cached: '<span class="b-tree__spacer"><span class="b-tree__i_expander_doClose"><img class="b-tree__i_expander_doClose_inner" alt="-" title="" src="Imga/i/null.gif" /></span></span>',
...
DR_EXPLAIN.data_menu = {
	// menu
	DREX_NODE_NAMES: ["Página principal","<Reporteria de Tickets>","Ventana Reportería de Tickets","Ventana de Impresiòn","Mensaje de Alerta","Pie de Página","Tabla de Utilidades","Tabla de Menu Principal","Tabla de Busqueda","Ventana Reportería de Tickets Abierto","Ventana Reportería de Tickets Cerrado ","Ventana Reportería de Tickets Asignados ","Ventana Estadìsticas por Departamento Destino ","Ventana Estadìsticas por Tema de Ayuda","Ventana Estadìsticas por Empleado","Ventana Estadìsticas por Departamento de Origen","Buscar Impresora","Ventana de Búsqueda Avanzada","Ventana Reportería de Tickets Avanzada","Ventana Detalles de Estadisticas Departamento Destino Según los Tickets","Ventana Detalles de los Temas de Ayuda Según los tickets","Ventana Detalles de los Tickets de los Empleados","Ventana Detalles de los departamento de origen según los tickets"],
	DREX_NODE_LINKS: ["index.html","___reporteria_de_tickets___.html","ventana_reporteria_de_tickets.html","ventana_de_impresion.html","mensaje_de_alerta.html","pie_de_pagina.html","tabla_de_utilidades.html","tabla_de_menu_principal.html","tabla_de_busqueda.html","ventana_reporteria_de_tickets_abierto.html","ventana_reporteria_de_tickets_cerrado_.html","ventana_reporteria_de_tickets_asignados_.html","ventana_estadisticas_por_departamento_destino_.html","ventana_estadisticas_por_tema_de_ayuda.html","ventana_estadisticas_por_empleado.html","ventana_estadisticas_por_departamento_de_origen.html","buscar_impresora.html","ventana_de_busqueda_avanzada.html","ventana_reporteria_de_tickets_avanzada.html","ventana_detalles_de_estadisticas_departamento_destino_segun_los_tickets.html","ventana_detalles_de_los_temas_de_ayuda_segun_los_tickets.html","ventana_detalles_de_los_tickets_de_los_empleados.html","ventana_detalles_de_los_departamento_de_origen_segun_los_tickets.html"],
	DREX_NODE_CHILD_START: [1,2,3,16,17,17,17,17,17,19,19,19,19,20,21,22,23,23,23,23,23,23,23],
	DREX_NODE_CHILD_END: [2,3,16,17,17,17,17,17,19,19,19,19,20,21,22,23,23,23,23,23,23,23,23],
	DREX_MENU_TYPE: 1,
