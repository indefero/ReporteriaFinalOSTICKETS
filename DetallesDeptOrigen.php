...
$VarExport=0; $VarExport =  $_COOKIE["VarCookie"];
?>
...
<title>Estadìsticas Departamento </title> <!--Titulo del archivo de indextab.php-->
...
<div class="AyudaDetalle">
 ...
 <form name="atrass" method="POST"  action="EstadisticasDepartOrigen.php">
         ...
         <p>Atras  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input style='background:url("img/atrasimg.png");' type="submit" name="BTNatras" id="BTNatras" value=" &nbsp;" onclick="self.location.href ='EstadisticasDepartOrigen.php'" onkeypress="self.location.href ='EstadisticasDepartOrigen.php'" Title="ir a resultados anteriores"S/></P>  
...
<?php
require_once("ConDetalleDeptOrigen.php");
?>
