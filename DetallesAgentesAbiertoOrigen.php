...
<title>Detalles </title> <!--Titulo del archivo de indextab.php-->
  ...
  <div class="subTituloEstadi0"><!--clases para ser utilizada en el archivo de css-->
       ...
       <H2><legend>Tickets Asignados en estado abiertos</br>Detalles del agente: <?php echo $VarExportAgente;?></legend></H2><!--Titulo que se muestra en la presentacion de la pagina web-->
  </div>
    </br></br>
...
<?php
require_once("ConDetallesAgentesAbOrigen.php");
?>
</div>
